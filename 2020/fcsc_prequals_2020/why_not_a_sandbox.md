...
Cependant, toujours en tatonnant, on trouve une fonction `open` dans le module _codecs_ qui fonctionne. Génial.
...
Voici donc la source de tous nos problèmes : seul _ctf-init_ peut lire `lib_flag.so`.
